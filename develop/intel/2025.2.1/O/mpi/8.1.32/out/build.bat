...
#SBATCH -o /gpfs/f6/c6_test_eval/world-shared/Gerhard.Theurich/ESMF-Nightly-Testing-C6/intel_2025.2.1_mpi_O_develop/build.bat_%j.o
#SBATCH -e /gpfs/f6/c6_test_eval/world-shared/Gerhard.Theurich/ESMF-Nightly-Testing-C6/intel_2025.2.1_mpi_O_develop/build.bat_%j.e
#SBATCH --time=1:00:00
#SBATCH --cluster=c6
#SBATCH --qos=normal
#SBATCH --nodes=1
...
module list >& /gpfs/f6/c6_test_eval/world-shared/Gerhard.Theurich/ESMF-Nightly-Testing-C6/intel_2025.2.1_mpi_O_develop/module-build.log

...
ESMF_APPSDIR=/tmp/nvhpc_25.5_mpi_O_develop/esmf/apps/appsO/Unicos.nvhpc.64.mpi.default
ESMF_LIBSDIR=/tmp/nvhpc_25.5_mpi_O_develop/esmf/lib/libO/Unicos.nvhpc.64.mpi.default
ESMF_ESMXDIR=/tmp/nvhpc_25.5_mpi_O_develop/esmf/src/addon/ESMX
ESMF_CMAKEDIR=/tmp/nvhpc_25.5_mpi_O_develop/esmf/cmake
...
ESMF_F90COMPILEPATHS=-I/tmp/nvhpc_25.5_mpi_O_develop/esmf/mod/modO/Unicos.nvhpc.64.mpi.default -I/tmp/nvhpc_25.5_mpi_O_develop/esmf/src/include -I/opt/cray/pe/netcdf/4.9.0.11/nvidia/23.3/include -I/opt/cray/pe/netcdf/4.9.0.11/nvidia/23.3/include
ESMF_F90COMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='develop+gc12f7f42f7' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_PIO=1 -DESMF_NETCDF=1 -DYAML=ESMF_YAML -DESMF_YAMLCPP=1 -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTPERFORMANCE -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Unicos=1 -DESMF_COMM=mpi -DESMF_DIR=/tmp/nvhpc_25.5_mpi_O_develop/esmf -DESMF_NO_F2018ASSUMEDTYPE
...
ESMF_F90LINKPATHS=-L/tmp/nvhpc_25.5_mpi_O_develop/esmf/lib/libO/Unicos.nvhpc.64.mpi.default -L/opt/cray/pe/netcdf/4.9.0.11/nvidia/23.3/lib
ESMF_F90ESMFLINKPATHS=-L/tmp/nvhpc_25.5_mpi_O_develop/esmf/lib/libO/Unicos.nvhpc.64.mpi.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/tmp/nvhpc_25.5_mpi_O_develop/esmf/lib/libO/Unicos.nvhpc.64.mpi.default  -Wl,-rpath,/opt/cray/pe/netcdf/4.9.0.11/nvidia/23.3/lib
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/tmp/nvhpc_25.5_mpi_O_develop/esmf/lib/libO/Unicos.nvhpc.64.mpi.default
...
ESMF_CXXCOMPILEPATHS= -I/tmp/nvhpc_25.5_mpi_O_develop/esmf/src/include  -I/opt/cray/pe/netcdf/4.9.0.11/nvidia/23.3/include -I/tmp/nvhpc_25.5_mpi_O_develop/esmf/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='develop+gc12f7f42f7' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_PIO=1 -DESMF_NETCDF=1 -DYAML=ESMF_YAML -DESMF_YAMLCPP=1 -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTPERFORMANCE -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Unicos=1 -DESMF_COMM=mpi -DESMF_DIR=/tmp/nvhpc_25.5_mpi_O_develop/esmf -D__SDIR__='' -DESMF_CXXSTD=11 -DESMF_NO_F2018ASSUMEDTYPE

ESMF_CXXLINKOPTS=  -mcmodel=small -pthread -Wl,--no-as-needed  -mp
ESMF_CXXLINKPATHS=-L/tmp/nvhpc_25.5_mpi_O_develop/esmf/lib/libO/Unicos.nvhpc.64.mpi.default -L/opt/cray/pe/netcdf/4.9.0.11/nvidia/23.3/lib
ESMF_CXXESMFLINKPATHS=-L/tmp/nvhpc_25.5_mpi_O_develop/esmf/lib/libO/Unicos.nvhpc.64.mpi.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/tmp/nvhpc_25.5_mpi_O_develop/esmf/lib/libO/Unicos.nvhpc.64.mpi.default  -Wl,-rpath,/opt/cray/pe/netcdf/4.9.0.11/nvidia/23.3/lib
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/tmp/nvhpc_25.5_mpi_O_develop/esmf/lib/libO/Unicos.nvhpc.64.mpi.default
...
ESMF_CCOMPILEPATHS=-I/tmp/nvhpc_25.5_mpi_O_develop/esmf/src/include   -I/tmp/nvhpc_25.5_mpi_O_develop/esmf/build_config/Unicos.nvhpc.default
ESMF_CCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='develop+gc12f7f42f7' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_PIO=1 -DESMF_NETCDF=1 -DYAML=ESMF_YAML -DESMF_YAMLCPP=1 -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTPERFORMANCE -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Unicos=1 -DESMF_COMM=mpi -DESMF_DIR=/tmp/nvhpc_25.5_mpi_O_develop/esmf -D__SDIR__=''

ESMF_CLINKOPTS=   -mp
ESMF_CLINKPATHS=-L/tmp/nvhpc_25.5_mpi_O_develop/esmf/lib/libO/Unicos.nvhpc.64.mpi.default -L/opt/cray/pe/netcdf/4.9.0.11/nvidia/23.3/lib -L/tmp/nvhpc_25.5_mpi_O_develop/esmf/lib/libO/Unicos.nvhpc.64.mpi.default -L/opt/cray/pe/netcdf/4.9.0.11/nvidia/23.3/lib
ESMF_CESMFLINKPATHS=-L/tmp/nvhpc_25.5_mpi_O_develop/esmf/lib/libO/Unicos.nvhpc.64.mpi.default
ESMF_CLINKRPATHS=-Wl,-rpath,/tmp/nvhpc_25.5_mpi_O_develop/esmf/lib/libO/Unicos.nvhpc.64.mpi.default -Wl,-rpath,/opt/cray/pe/netcdf/4.9.0.11/nvidia/23.3/lib -Wl,-rpath,/tmp/nvhpc_25.5_mpi_O_develop/esmf/lib/libO/Unicos.nvhpc.64.mpi.default -Wl,-rpath,/opt/cray/pe/netcdf/4.9.0.11/nvidia/23.3/lib
ESMF_CESMFLINKRPATHS=-Wl,-rpath,/tmp/nvhpc_25.5_mpi_O_develop/esmf/lib/libO/Unicos.nvhpc.64.mpi.default
...
ESMF_TRACE_LDPRELOAD=/tmp/nvhpc_25.5_mpi_O_develop/esmf/lib/libO/Unicos.nvhpc.64.mpi.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/tmp/nvhpc_25.5_mpi_O_develop/esmf
ESMF_INTERNAL_MPIRUN="/tmp/nvhpc_25.5_mpi_O_develop/esmf/scripts/mpirun.srun "

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /tmp/nvhpc_25.5_mpi_O_develop/esmf
# ESMF_OS: Unicos
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
# ESMF_COMPILER: nvhpc
